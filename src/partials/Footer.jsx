        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm space-y-2">
              <li>
                <a className="text-gray-400 hover:text-blue-500 transition duration-150 ease-in-out" href="/about">Our Story</a>
              </li>
              <li>
                <a className="text-gray-400 hover:text-blue-500 transition duration-150 ease-in-out" href="https://github.com/letterpad/letterpad">Contribute</a>
              </li>
            </ul>
          </div>
        </div>
