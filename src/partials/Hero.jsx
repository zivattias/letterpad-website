        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-xl mx-auto md:max-w-[640px] md:mx-0 text-center md:text-left">
            ...
            <h1 className="h1 font-uncut-sans mb-6" data-aos="zoom-out" data-aos-delay="100">
              A publishing platform for <em className="font-italic">creative</em> people
            </h1>
            ...
            >
              <div>
                <a className="btn text-white bg-gradient-to-t from-blue-600 to-blue-400 hover:to-blue-500 w-full shadow-lg group" href="/admin/register" onClick={() => {
                  track({
              ...
              <div>
                <a className="btn text-gray-300 bg-gradient-to-t from-gray-800 to-gray-700 hover:to-gray-800 w-full shadow-lg" href="https://docs.letterpad.app" onClick={() => {
                  track({
                    eventAction: EventAction.Click,
                    eventCategory: "docs",
                    eventLabel: `header`,
