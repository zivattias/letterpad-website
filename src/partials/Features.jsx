      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="text-center pb-12 md:pb-20">
            <h2 className="h2 font-uncut-sans" data-aos="zoom-out">Elevate your content creation</h2>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-3 lg:gap-16 items-start md:max-w-none">
            ...
            <div className="flex flex-col items-center" data-aos="zoom-out">
              ...
              <h4 className="h4 text-gray-200 text-center mb-2">Customization</h4>
              <p className="text-lg text-gray-400 text-center">Easily customize the appearance of your blog to match your personal style and branding.</p>
            </div>
            {/* 2nd item */}
            <div className="flex flex-col items-center" data-aos="zoom-out" data-aos-delay="200">
              ...
              <h4 className="h4 text-gray-200 text-center mb-2">Easy-to-use editor</h4>
              <p className="text-lg text-gray-400 text-center">Our content editor is intuitive and user-friendly, allowing you to easily create and publish content.</p>
            </div>
            {/* 3rd item */}
            <div className="flex flex-col items-center" data-aos="zoom-out" data-aos-delay="400">
              ...
              <h4 className="h4 text-gray-200 text-center mb-2">Custom domains</h4>
              <p className="text-lg text-gray-400 text-center">Use your own custom domain name for your blog, rather than a subdomain on the blogging platform's domain.</p>
            </div>
          </div>
        </div>
      </div>
